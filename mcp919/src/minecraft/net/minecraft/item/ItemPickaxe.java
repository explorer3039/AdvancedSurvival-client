...
public class ItemPickaxe extends ItemTool
{
    ...
    {
        if (blockIn == Blocks.netherrack || blockIn == Blocks.quartz_ore) return this.toolMaterial.getHarvestLevel() >= 5;
        else if (blockIn == Blocks.obsidian || blockIn == Blocks.emerald_ore || blockIn == Blocks.emerald_block || blockIn == Blocks.emerald_ore) return this.toolMaterial.getHarvestLevel() >= 4;
