...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(6, "sapling", (new BlockSapling()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("sapling"));
        registerBlock(7, "bedrock", (new Block(Material.rock)).setHardness(150.0F).setResistance(6000000.0F).setStepSound(soundTypePiston).setUnlocalizedName("bedrock").disableStats().setCreativeTab(CreativeTabs.tabBlock));
        ...
        registerBlock(31, "tallgrass", (new BlockTallGrass()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("tallgrass"));
        registerBlock(32, "deadbush", (new BlockDeadBush()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("deadbush"));
        ...
        registerBlock(37, "yellow_flower", (new BlockYellowFlower()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("flower1"));
        registerBlock(38, "red_flower", (new BlockRedFlower()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("flower2"));
        Block block3 = (new BlockMushroom()).setHardness(0.20F).setStepSound(soundTypeGrass).setLightLevel(0.125F).setUnlocalizedName("mushroom");
        registerBlock(39, "brown_mushroom", block3);
        Block block4 = (new BlockMushroom()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("mushroom");
        ...
        registerBlock(46, "tnt", (new BlockTNT()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("tnt"));
        ...
        registerBlock(50, "torch", (new BlockTorch()).setHardness(0.20F).setLightLevel(0.9375F).setStepSound(soundTypeWood).setUnlocalizedName("torch"));
        registerBlock(51, "fire", (new BlockFire()).setHardness(0.20F).setLightLevel(1.0F).setStepSound(soundTypeCloth).setUnlocalizedName("fire").disableStats());
        ...
        registerBlock(55, "redstone_wire", (new BlockRedstoneWire()).setHardness(0.20F).setStepSound(soundTypeStone).setUnlocalizedName("redstoneDust").disableStats());
        ...
        registerBlock(75, "unlit_redstone_torch", (new BlockRedstoneTorch(false)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("notGate"));
        registerBlock(76, "redstone_torch", (new BlockRedstoneTorch(true)).setHardness(0.20F).setLightLevel(0.5F).setStepSound(soundTypeWood).setUnlocalizedName("notGate").setCreativeTab(CreativeTabs.tabRedstone));
        ...
        registerBlock(83, "reeds", (new BlockReed()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("reeds").disableStats());
        ...
        registerBlock(93, "unpowered_repeater", (new BlockRedstoneRepeater(false)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("diode").disableStats());
        registerBlock(94, "powered_repeater", (new BlockRedstoneRepeater(true)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("diode").disableStats());
        ...
        registerBlock(104, "pumpkin_stem", (new BlockStem(block7)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("pumpkinStem"));
        registerBlock(105, "melon_stem", (new BlockStem(block9)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("pumpkinStem"));
        ...
        registerBlock(111, "waterlily", (new BlockLilyPad()).setHardness(0.20F).setStepSound(soundTypeGrass).setUnlocalizedName("waterlily"));
        ...
        registerBlock(140, "flower_pot", (new BlockFlowerPot()).setHardness(0.20F).setStepSound(soundTypeStone).setUnlocalizedName("flowerPot"));
        ...
        registerBlock(149, "unpowered_comparator", (new BlockRedstoneComparator(false)).setHardness(0.20F).setStepSound(soundTypeWood).setUnlocalizedName("comparator").disableStats());
        registerBlock(150, "powered_comparator", (new BlockRedstoneComparator(true)).setHardness(0.20F).setLightLevel(0.625F).setStepSound(soundTypeWood).setUnlocalizedName("comparator").disableStats());
